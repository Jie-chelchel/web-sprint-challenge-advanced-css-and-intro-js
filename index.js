...
function get20s(arr) {
  ...
  for (let i = 0; i < arr.length; i++) {
    ...
    const deathYear = (arr[i]['years'].split(" ")[2]);
  ...
  arr.push(
    {
      ...
      "genre": "Web Design",
      "nationality": "China",
      "bio": "Lorem, ipsum dolor sit amet consectetur adipisicing elit.Recusandae aliquam velit eius atque veniam debitis modi sed vero ex perferendis provident",
